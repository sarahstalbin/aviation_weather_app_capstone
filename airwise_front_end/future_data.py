...
def get_raw_weather_data(location='Seattle', current_state='future'):
    ...
    if current_state == 'future':
        ...
        url = f'https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/{city}/{start_date}/{end_date}?key={api_key}&include=days&elements=datetime,temp,humidity,precip,visibility'
